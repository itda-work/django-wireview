...
from testproj.e2e_browser import expect_text, wait_live
...
class TestLiveComponentE2E:
    ...
    def test_dashboard_loads_with_counters(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="count-counter-1"]'), "0")
        expect_text(page.locator('[data-testid="count-counter-2"]'), "10")
        expect_text(page.locator('[data-testid="count-counter-3"]'), "5")

        # Check total
        expect_text(page.locator('[data-testid="total"]'), "15")
    ...
    def test_increment_counter_with_myself_targeting(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="count-counter-1"]'), "1")
        ...
        page.locator('[data-testid="increment-counter-1"]').click()
        expect_text(page.locator('[data-testid="count-counter-1"]'), "2")
    ...
    def test_decrement_counter(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="count-counter-2"]'), "9")
    ...
    def test_reset_individual_counter(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="count-counter-2"]'), "0")
    ...
    def test_send_to_parent_updates_dashboard(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="last-changed"]'), "counter-1: 1")

        # Total should now be 16
        expect_text(page.locator('[data-testid="total"]'), "16")
    ...
    def test_parent_reset_all_updates_children(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="count-counter-1"]'), "0")
        expect_text(page.locator('[data-testid="count-counter-2"]'), "0")
        expect_text(page.locator('[data-testid="count-counter-3"]'), "0")

        # Total should be 0
        expect_text(page.locator('[data-testid="total"]'), "0")

        # Last changed should indicate all reset
        expect_text(page.locator('[data-testid="last-changed"]'), "All reset")
    ...
    def test_parent_sync_all_updates_children(self, page, livecomp_server):
        ...
        expect_text(page.locator('[data-testid="count-counter-1"]'), "5")
        expect_text(page.locator('[data-testid="count-counter-2"]'), "5")
        expect_text(page.locator('[data-testid="count-counter-3"]'), "5")
    ...
    def test_a_reset_counter_survives_an_unrelated_parent_rerender(self, page, livecomp_server):
        ...
        # Proving something did *not* change needs a window to not change in;
        # a retrying assertion would pass on the value that was already there.
